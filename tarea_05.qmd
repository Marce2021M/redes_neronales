---
title: "Tarea 5_Redes Neuronales Simples y Regularización"
output:
  html_document:
    self_contained: true
cache: true
...
ggplot2::ggplot(dat_3, aes(x = x, y = f_2)) + 
  ggplot2::geom_line()+
  ggplot2::geom_line(data = dat_f, aes(x = x, y = f), col='red') +
  ggplot2::geom_point(data = datos, aes(x = x_1, y = y))
```
